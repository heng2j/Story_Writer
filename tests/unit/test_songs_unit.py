...
# Internal modules
from src.songs import get_partial_match_substring ,get_top_sample_lyrics , get_one_song, create_song, delete_song , create_update_song
...
def test_create_delete_Song():
    ...
    make_response, code = delete_song(new_song)
